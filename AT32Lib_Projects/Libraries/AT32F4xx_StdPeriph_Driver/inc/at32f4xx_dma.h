...
#define DMA_FLEXIBLE_SDIO           ((uint8_t)0x31)
...
#define IS_DMA_ALL_HARDWARE_ID(HARDWARE_ID)     (((HARDWARE_ID) == DMA_FLEXIBLE_ADC1) || ((HARDWARE_ID) == DMA_FLEXIBLE_SPI1_RX)  || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_SPI1_TX)  || ((HARDWARE_ID) == DMA_FLEXIBLE_SPI2_RX)  || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_SPI2_TX)  || ((HARDWARE_ID) == DMA_FLEXIBLE_UART1_RX) || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_UART1_TX) || ((HARDWARE_ID) == DMA_FLEXIBLE_UART2_RX) || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_UART2_TX) || ((HARDWARE_ID) == DMA_FLEXIBLE_UART3_RX) || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_UART3_TX) || ((HARDWARE_ID) == DMA_FLEXIBLE_UART4_RX) || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_UART4_TX) || ((HARDWARE_ID) == DMA_FLEXIBLE_UART5_RX) || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_UART5_TX) || ((HARDWARE_ID) == DMA_FLEXIBLE_I2C1_RX)  || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_I2C1_TX)  || ((HARDWARE_ID) == DMA_FLEXIBLE_I2C2_RX)  || \
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_I2C2_TX)  || ((HARDWARE_ID) == DMA_FLEXIBLE_SDIO)     || \
                                                 ...
                                                 ((HARDWARE_ID) == DMA_FLEXIBLE_TIM5_CH4) || ((HARDWARE_ID) == DMA_FLEXIBLE_TIM8_TRIG)|| \
