...
#define RCC_CLKOUT_AHB              ((uint32_t)0x20020000)
#define RCC_CLKOUT_APB1             ((uint32_t)0x20040000)
#define RCC_CLKOUT_APB2             ((uint32_t)0x20060000)
#define RCC_CLKOUT_TIM1             ((uint32_t)0x20080000)
#define RCC_CLKOUT_TIM2             ((uint32_t)0x200A0000)
#endif
#ifdef AT32F413xx
#define IS_RCC_CLKOUT(CLK)          (((CLK) == RCC_CLKOUT_NOCLK)    || ((CLK) == RCC_CLKOUT_HSI)      || \
                                     ...
                                     ((CLK) == RCC_CLKOUT_AHB)      || ((CLK) == RCC_CLKOUT_APB1)     || \
                                     ((CLK) == RCC_CLKOUT_APB2)     || ((CLK) == RCC_CLKOUT_TIM1)     || \
                                     ((CLK) == RCC_CLKOUT_TIM2))
#endif
#ifdef AT32F403xx
#define IS_RCC_CLKOUT(CLK)          (((CLK) == RCC_CLKOUT_NOCLK)    || ((CLK) == RCC_CLKOUT_HSI)      || \
...
/** @defgroup RCC_413_new_added
  * @{
  */
#ifdef AT32F413xx
#define RCC_MISC2_AUTO_STEP_MODE     ((uint32_t)0x00000030)
#define RCC_INTCTRL_USB_INT_REMAP    ((uint32_t)0x00000001)

#define RCC_MISC_HSI_DIV_EN          ((uint32_t)0x02000000)
#define RCC_MISC2_HSI_FOR_USB        ((uint32_t)0x00000100)

#define RCC_TEST_MCO2TMR_EN          ((uint32_t)0x00010000)
#define RCC_TEST_CLKOUT_SEL          ((uint32_t)0x000E0000)
#endif
/**
  * @}
  */
