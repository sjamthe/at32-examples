...
#ifdef AT32F413xx
#if !defined (AT32FEBKCx_MD)
#define  RCC_AHBEN_SDIOEN                       ((uint16_t)0x0400)            /*!< SDIO clock enable */
...
#define  FLASH_SLIB_PSW                         ((uint32_t)0xFFFFFFFF)        /*!< SLIB password */
